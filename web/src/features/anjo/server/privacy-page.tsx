  ...
  return (
    <article className="anjo-markdown">
      ...
      <p>
        <Furigana>
          {
            "質問と参照資料は回答生成のためVercel AI GatewayとGoogleのGeminiモデルへ送られます。個人情報や非公開の情報は入力しないでください。運営用DBには質問本文を保存せず、日時・モデル・トークン数・推計費用・成功／失敗・連続送信を制限する日替わり識別番号を記録します。サービス提供会社の運用ログについては各社の規約が適用されます。"
          }
        </Furigana>
      </p>
      <h2>
